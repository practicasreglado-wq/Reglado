    ...
    <div class="container">
      <div class="legal-card">
        ...
        <div class="legal-content">
          ...
          <p>En REGLADO GROUP S.L tratamos la información que nos facilitan las personas interesadas con las siguientes finalidades:</p>
          <ul>
            <li>Gestionar el registro de usuarios y el acceso a los servicios de {{ projectName }}.</li>
            <li>Tramitar el envío de la información que nos soliciten a través de los diversos formularios de contacto.</li>
            <li>Prestar los servicios contratados por el usuario relacionados con el ecosistema Reglado.</li>
          ...
          <p>La base legal para el tratamiento de sus datos es el consentimiento del interesado al registrarse en el portal o al enviar una consulta a través de nuestros formularios.</p>

          <p><strong>5. ¿A QUÉ DESTINATARIOS SE COMUNICARÁN SUS DATOS?</strong></p>
          <p>Los datos no se cederán a terceros salvo en los casos en que exista una obligación legal o sea necesario para la prestación del servicio solicitado (ej. comunicación a empresas del grupo para servicios específicos).</p>

          <p><strong>6. ¿CUÁLES SON SUS DERECHOS AL FACILITARNOS SUS DATOS?</strong></p>
          <p>Cualquier persona tiene derecho a obtener confirmación sobre si en REGLADO GROUP S.L estamos tratando datos personales que les conciernan, o no. Las personas interesadas tienen derecho a:</p>
          <ul>
          ...
          <p>Para ejercer estos derechos, puede dirigirse a {{ contactEmail }} adjuntando copia de su DNI.</p>
