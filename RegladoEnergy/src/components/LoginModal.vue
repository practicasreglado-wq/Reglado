        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="handleLogin" class="login-form">
            ...
            <div class="form-options">
              <span></span>
              <a :href="recoverUrl" target="_blank" rel="noopener" class="forgot-password">
          ...
          <div class="modal-footer">
            <p>
              ¿No tienes cuenta?
              <a :href="registerUrl" target="_blank" rel="noopener">Regístrate aquí</a>
            </p>
          </div>
        </div>
      </div>
...
const grupoBase = import.meta.env.VITE_GRUPO_REGLADO_BASE_URL || "http://localhost:5173";
const registerPath = import.meta.env.VITE_GRUPO_REGLADO_REGISTER_PATH || "/registro";
const recoverPath = import.meta.env.VITE_GRUPO_REGLADO_RECOVER_PATH || "/recuperar-contrasena";
const registerUrl = new URL(registerPath, grupoBase).toString();
const recoverUrl = new URL(recoverPath, grupoBase).toString();
