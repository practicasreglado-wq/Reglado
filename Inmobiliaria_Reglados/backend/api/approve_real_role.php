...
if ($email === '' || !filter_var($email, FILTER_VALIDATE_EMAIL) || $token === '') {
    ...
    echo "<h1 style='color:red;font-family:sans-serif;'>Error: Email o token no válido.</h1>";
    exit;
}
...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'realstate@regladoconsultores.com';
    $mail->Password = 'Reglado130891.*';
    $mail->SMTPSecure = \PHPMailer\PHPMailer\PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port = 587;

    $mail->setFrom('realstate@regladoconsultores.com', 'Reglado Real Estate');
    $mail->addAddress($email);
    $mail->addReplyTo('realstate@regladoconsultores.com', 'Reglado Real Estate');
