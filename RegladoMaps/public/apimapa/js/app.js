...
var iconos = {
    subestacion: L.icon({
        iconUrl: '/apimapa/assets/img/subestacion.png',
        iconSize: [32, 32],
        className: 'icon-subestacion'
    }),
    eolica: L.icon({
        iconUrl: '/apimapa/assets/img/eolica.png',
        iconSize: [32, 32],
        className: 'icon-eolica'
    }),
    solar: L.icon({
        iconUrl: '/apimapa/assets/img/solar.png',
        iconSize: [35, 35],
        className: 'icon-solar'
    }),
    biometano: L.icon({
        iconUrl: '/apimapa/assets/img/biometano.png',
        iconSize: [32, 32],
        className: 'icon-biometano'
    }),
    hidrogeno: L.icon({
        iconUrl: '/apimapa/assets/img/hidrogeno.png',
        iconSize: [32, 32],
        className: 'icon-hidrogeno'
    }),
    hidraulica: L.icon({
        iconUrl: '/apimapa/assets/img/Hidraulica.png',
        iconSize: [32, 32],
        className: 'icon-Hidraulica'
    }),
    biodiesel: L.icon({
        iconUrl: '/apimapa/assets/img/biodiesel.png',
        iconSize: [32, 32],
